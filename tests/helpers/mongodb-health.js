...
async function checkMongoDB() {
  ...
  try {
    ...
    if (error.message.includes('ECONNREFUSED')) {
      ...
      log('yellow', '  • Or use: brew services start mongodb-community (macOS)');
    ...
    log('cyan', '  • MongoDB Installation: https://docs.mongodb.com/manual/installation/');
    log('cyan', '  • Connection Troubleshooting: https://docs.mongodb.com/manual/reference/connection-string/');
    ...
    if (client) {
      try {
        ...
        log('yellow', `Warning: Failed to close connection: ${closeError.message}`);
      }
    }
  }
}
